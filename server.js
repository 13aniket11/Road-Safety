...
const firebaseConfig = {
  apiKey: "AIzaSyB9jnIRsSQ-hplASwm4uIE47T0pPPOEyxU",
  authDomain: "road-safety-b918f.firebaseapp.com",
  databaseURL: "https://road-safety-b918f-default-rtdb.firebaseio.com",
  projectId: "road-safety-b918f",
  storageBucket: "road-safety-b918f.appspot.com",
  messagingSenderId: "1044665346706",
  appId: "1:1044665346706:web:b4c87c6bfa655406dd144b"
};
...
appp.get('/', async function (req, res) {
  res.send("This is honme page");
})

appp.get('/login', async function (req, res) {
  res.send("gis Login olage");
})

appp.get('/setting', async function (req, res) {
  res.sendFile(__dirname + '\\index.html');
})
appp.get('/map', async function (req, res) {
  try {

    const defaultDatabase = collection(firestore, 'users');
    const Docs = await getDocs(defaultDatabase);
    const document = []
    var links = ""
    Docs.forEach((data) => {
